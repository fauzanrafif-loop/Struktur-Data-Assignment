# <h1 align="center">Laporan Praktikum Modul 12 tentang Multi Linked List </h1>
<p align="center">Fauzan Rafif - 103112400227</p>

## Dasar Teori

Multi Linked List adalah struktur data yang terdiri dari beberapa linked list yang saling terhubung, di mana setiap elemen dapat menjadi bagian dari lebih dari satu list. Dalam modul ini, multi linked list diimplementasikan dengan dua jenis list: list induk (main list) dan list anak (sublist). Operasi dasar pada multi linked list meliputi penambahan (insert) dan penghapusan (delete) baik pada  induk maupun anak. Penambahan elemen anak harus selalu merujuk pada induknya terlebih dahulu, sementara penghapusan elemen induk harus diikuti dengan penghapusan seluruh anak yang terkait untuk menghindari memori yang tidak terpakai. Operasi dasar yang digunakan yaitu :

- Insert Anak: menambahkan elemen anak ke dalam list anak milik induk tertentu.
- Insert Induk: menambahkan elemen induk ke list induk.
- Delete Anak: menghapus elemen anak dari list anak milik induk tertentu.
- Delete Induk: menghapus elemen induk beserta seluruh list anaknya.
...
```
Kode di atas digunakan untuk mengelola dan membuat struktur data Multi Linked List berupa Kategori (Parent) dan Makanan (Child).
...
```
Kode program tersebut berfungsi dimana setiap induk dapat memiliki sejumlah anak. Proses dimulai dengan membuat list induk, kemudian menambahkan beberapa elemen induk serta mengisi masing-masing dengan anak melalui pemanggilan fungsi insert. Program juga melakukan percobaan penghapusan, baik menghapus anak tertentu maupun menghapus sebuah induk beserta seluruh anak yang terkait.

#### Output:

<img width="555" height="507" alt="Image" src="https://github.com/user-attachments/assets/c20ada61-3e21-4ee0-af6e-ef7b52a44243" />

### 3. Buatlah ADT Multi Linked list sebagai berikut di dalam file “circularlist.h”: 

<img width="842" height="1252" alt="Image" src="https://github.com/user-attachments/assets/c38db3d0-6d27-4531-a74f-5b5c06085205" />
<img width="703" height="1211" alt="Image" src="https://github.com/user-attachments/assets/cb18151f-0ce8-43f4-bce5-849e2b741292" />
...
```
Kode program diatas digunakan untuk membangun Circular Doubly Linked List untuk menyimpan data mahasiswa, di mana setiap node terhubung dua arah dan keseluruhan list membentuk struktur melingkar. Data mahasiswa ditambahkan dengan berbagai metode, yaitu penyisipan di bagian awal list, di bagian akhir, serta penyisipan setelah node tertentu. Setelah proses penambahan selesai, program menampilkan seluruh isi list dengan melakukan traversal secara melingkar mulai dari node pertama.

#### Output:

<img width="541" height="1103" alt="Image" src="https://github.com/user-attachments/assets/9c4e343f-29c9-438e-a792-6fc8077354f4" />

#### Full code Screenshot:

<img width="2560" height="1600" alt="Image" src="https://github.com/user-attachments/assets/0da08cd5-473d-4d5c-bf4e-c9f9256c5e11" />

## Kesimpulan

Pada modul 12 ini tentang Multi Linked List Struktur ini memisahkan data induk dan anak ke dalam list yang berbeda, namun tetap menjaga keterhubungan antara keduanya melalui pointer. Modul menekankan bahwa meskipun konsep Multi Linked List mirip dengan linked list biasa, kompleksitasnya lebih tinggi karena setiap elemen induk membawa list anak di dalamnya. Operasi dasar seperti penyisipan dan penghapusan harus dilakukan lebih hati-hati, terutama ketika menghapus induk yang memiliki anak, karena seluruh elemen anak harus ikut dihapus. Modul ini menunjukkan pentingnya menjaga konsistensi hubungan antara list induk dan list anak, terutama saat melakukan operasi insert dan delete.

## Referensi
[1] Utami, E., Kom, M., Dhuhita, W. M. P., Kom, S., & Kom, M. (2017). Langkah Mudah Belajar Struktur Data Menggunakan C/C++. Elex Media Komputindo.